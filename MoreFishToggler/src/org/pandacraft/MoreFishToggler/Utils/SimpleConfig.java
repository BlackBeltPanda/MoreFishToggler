package org.pandacraft.MoreFishToggler.Utils;
...
public class SimpleConfig {
    ...
    public SimpleConfig(InputStream configStream, File configFile, int comments, JavaPlugin plugin) {
        ...
        Reader defConfigReader = new InputStreamReader(configStream);
        this.config = YamlConfiguration.loadConfiguration(defConfigReader);
    }
    ...
    public void reloadConfig() {
    	Reader defConfigReader = new InputStreamReader(manager.getConfigContent(file));
        this.config = YamlConfiguration.loadConfiguration(defConfigReader);
    }
